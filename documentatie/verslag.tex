...
De term heeft de vorm \texttt{analyse(MaxInstructions, CurrentCounter, Inputs, BadInputs, PathTrace)}. Tijdens de uitvoering worden velden bijgewerkt door \texttt{src/function\_runner.pl}:
